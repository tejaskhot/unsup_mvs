...
# dataset parameters
tf.app.flags.DEFINE_string('dense_folder', '/home/tejas/unsup_mvs/data/mvs_testing/dtu',
                           """Root path to dense folder.""")
tf.app.flags.DEFINE_string('output_folder', '/home/tejas/unsup_mvs/outputs/',
                           """Root path to output folder.""")
tf.app.flags.DEFINE_string('model_dir', '/home/tejas/unsup_mvs/saved_models/lambda1_128_nc3',
                           """Path to restore the model.""")
tf.app.flags.DEFINE_integer('ckpt_step', 45000,
                            """ckpt step.""")
...
def main(_):  # pylint: disable=unused-argument
    ...
    for scan in scans:
        print('scan : ', scan)
        mvs_list = gen_pipeline_mvs_list(os.path.join(FLAGS.dense_folder, scan))
